export namespace Models {
    ...
    export type Log = {
        ...
        time: string;
        /**
         * Operating system code name. View list of [available options](https://github.com/khulnasoft/getapp/blob/master/docs/lists/os.json).
         */
        osCode: string;
        /**
        ...
        clientType: string;
        /**
         * Client code name. View list of [available options](https://github.com/khulnasoft/getapp/blob/master/docs/lists/clients.json).
         */
        clientCode: string;
        /**
         * Client name.
