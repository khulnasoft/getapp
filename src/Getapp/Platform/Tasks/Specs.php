...
use Getapp\Specification\Format\OpenAPI3;
use Getapp\Specification\Format\Swagger2;
use Getapp\Specification\Specification;
        ...
        foreach ($platforms as $platform) {
            ...
            foreach (['swagger2', 'open-api3'] as $format) {
                ...
                $formatInstance
                    ...
                    ->setParam('license.url', 'https://raw.githubusercontent.com/khulnasoft/getapp/master/LICENSE')
