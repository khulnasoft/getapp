...
namespace Getapp\GraphQL\Types;

use Getapp\GraphQL\Resolvers;
use Getapp\GraphQL\Types;
use Exception;
...
class Mapper
{
    ...
    public static function param(
        ...
        switch ((!empty($validator)) ? $validator::class : '') {
            case 'Getapp\Network\Validator\CNAME':
            case 'Getapp\Task\Validator\Cron':
            case 'Getapp\Utopia\Database\Validator\CustomId':
            case 'Utopia\Validator\Domain':
            case 'Getapp\Network\Validator\Email':
            case 'Getapp\Event\Validator\Event':
            case 'Getapp\Event\Validator\FunctionEvent':
            ...
            case 'Getapp\Utopia\Database\Validator\Queries\Base':
