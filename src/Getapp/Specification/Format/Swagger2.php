...
namespace Getapp\Specification\Format;

use Getapp\Specification\Format;
use Getapp\Template\Template;
        ...
        */
        $output = [
            ...
            'info' => [
                ...
                'license' => [
                    'name' => 'BSD-3-Clause',
                    'url' => 'https://raw.githubusercontent.com/khulnasoft/getapp/master/LICENSE',
                ],
            ],
        ...
        foreach ($this->routes as $route) {
            ...
            $temp = [
                ...
                'x-appwrite' => [ // Appwrite related metadata
                    ...
                    'edit' => 'https://github.com/khulnasoft/getapp/edit/master' . $route->getLabel('sdk.description', ''),
            ...
            foreach ($parameters as $name => $param) { // Set params
                ...
                switch ((!empty($validator)) ? \get_class($validator) : '') {
                    ...
                    case 'Utopia\Validator\Boolean':
                        ...
                        break;
                    case 'Getapp\Utopia\Database\Validator\CustomId':
                    ...
                    case 'Utopia\Database\Validator\DatetimeValidator':
                        ...
                        break;
                    case 'Getapp\Network\Validator\Email':
                        $node['type'] = $validator->getType();
                        $node['format'] = 'email';
                    ...
                    case 'Utopia\Storage\Validator\File':
                        ...
                        $node['type'] = 'file';
                        break;
                    case 'Getapp\Utopia\Database\Validator\Queries\Attributes':
                    case 'Getapp\Utopia\Database\Validator\Queries\Buckets':
                    case 'Getapp\Utopia\Database\Validator\Queries\Collections':
                    case 'Getapp\Utopia\Database\Validator\Queries\Databases':
                    case 'Getapp\Utopia\Database\Validator\Queries\Deployments':
                    case 'Getapp\Utopia\Database\Validator\Queries\Executions':
                    case 'Getapp\Utopia\Database\Validator\Queries\Files':
                    case 'Getapp\Utopia\Database\Validator\Queries\Functions':
                    case 'Getapp\Utopia\Database\Validator\Queries\Identities':
                    case 'Getapp\Utopia\Database\Validator\Queries\Indexes':
                    case 'Getapp\Utopia\Database\Validator\Queries\Installations':
                    case 'Getapp\Utopia\Database\Validator\Queries\Memberships':
                    case 'Getapp\Utopia\Database\Validator\Queries\Messages':
                    case 'Getapp\Utopia\Database\Validator\Queries\Migrations':
                    case 'Getapp\Utopia\Database\Validator\Queries\Projects':
                    case 'Getapp\Utopia\Database\Validator\Queries\Providers':
                    case 'Getapp\Utopia\Database\Validator\Queries\Rules':
                    case 'Getapp\Utopia\Database\Validator\Queries\Subscribers':
                    case 'Getapp\Utopia\Database\Validator\Queries\Targets':
                    case 'Getapp\Utopia\Database\Validator\Queries\Teams':
                    case 'Getapp\Utopia\Database\Validator\Queries\Topics':
                    case 'Getapp\Utopia\Database\Validator\Queries\Users':
                    case 'Getapp\Utopia\Database\Validator\Queries\Variables':
                    ...
                    case 'Utopia\Database\Validator\Roles':
                        ...
                        break;
                    case 'Getapp\Auth\Validator\Password':
                        $node['type'] = $validator->getType();
                        $node['format'] = 'password';
                        $node['x-example'] = 'password';
                        break;
                    case 'Getapp\Auth\Validator\Phone':
                        $node['type'] = $validator->getType();
                        $node['format'] = 'phone';
                    ...
                    case 'Utopia\Validator\WhiteList':
                        ...
                        break;
                    case 'Getapp\Utopia\Database\Validator\CompoundUID':
                        $node['type'] = $validator->getType();
