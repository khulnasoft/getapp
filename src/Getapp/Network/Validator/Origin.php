...
namespace Getapp\Network\Validator;
...
class Origin extends Validator
{
    ...
    public const SCHEME_TYPE_IOS = 'getapp-ios';
    public const SCHEME_TYPE_MACOS = 'getapp-macos';
    public const SCHEME_TYPE_WATCHOS = 'getapp-watchos';
    public const SCHEME_TYPE_TVOS = 'getapp-tvos';
    public const SCHEME_TYPE_ANDROID = 'getapp-android';
    public const SCHEME_TYPE_WINDOWS = 'getapp-windows';
    public const SCHEME_TYPE_LINUX = 'getapp-linux';
