...
> If you are experienced with GitHub or have made a pull request before, you can skip to [Implement new runtime](https://github.com/khulnasoft/getapp/blob/master/docs/tutorials/add-runtime.md#2-implement-new-runtime).
...
[![Fork button](https://github.com/khulnasoft/getapp/raw/master/docs/tutorials/images/fork.png)](https://github.com/khulnasoft/getapp/blob/master/docs/tutorials/images/fork.png)
...
$dart->addVersion('2.12', 'dart-runtime:2.12', 'getapp-ubuntu:20.04', [System::X86, System::ARM]);
...
For interpreted languages, this is normally the same as the Build Image, but for compiled languages, this can be either "getapp-alpine:3.13.6" or "getapp-ubuntu:20.04"
