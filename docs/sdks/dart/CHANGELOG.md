...
**Full Changelog for Appwrite 1.0.0 can be found here**: https://github.com/khulnasoft/getapp/blob/master/CHANGES.md
...
**Full Changelog for Appwrite 0.15 can be found here**: https://github.com/khulnasoft/getapp/blob/master/CHANGES.md#version-0150
...
**Full Changelog for Appwrite 0.13 can be found here**: https://github.com/khulnasoft/getapp/blob/master/CHANGES.md#version-0130
...
- [View all the changes](https://github.com/khulnasoft/getapp/blob/master/CHANGES.md#version-0120)
