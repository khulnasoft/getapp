...
Before you start contributing, familiarize yourself with our project by reading the [main README](https://github.com/khulnasoft/getapp/blob/main/README.md).
...
Please review our [Contributing Guide](https://github.com/khulnasoft/getapp/blob/main/CONTRIBUTING.md) before contributing. It will help you learn about the architecture, instructions on how to update code, run tests, and submit a PR.
