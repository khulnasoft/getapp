...
use Getapp\Auth\MFA\Type\TOTP;
use Getapp\Auth\OAuth2\Exception as OAuth2Exception;
use Getapp\Auth\Phrase;
use Getapp\Auth\Validator\Password;
use Getapp\Auth\Validator\PasswordDictionary;
use Getapp\Auth\Validator\PasswordHistory;
use Getapp\Auth\Validator\PersonalData;
use Getapp\Auth\Validator\Phone;
use Getapp\Detector\Detector;
...
use Getapp\URL\URL as URLParser;
use Getapp\Utopia\Database\Validator\CustomId;
use Getapp\Utopia\Database\Validator\Queries\Identities;
...
App::patch('/v1/account/sessions/:sessionId')
    ...
    ->action(function (?string $sessionId, Response $response, Document $user, Database $dbForProject, Document $project, Event $queueForEvents) {
        ...
        $className = 'Getapp\\Auth\\OAuth2\\' . \ucfirst($provider);
