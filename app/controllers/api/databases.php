...
use Getapp\Utopia\Database\Validator\Queries\Attributes;
use Getapp\Utopia\Database\Validator\Queries\Collections;
use Getapp\Utopia\Database\Validator\Queries\Databases;
use Getapp\Utopia\Database\Validator\Queries\Indexes;
...
App::init()
    ...
    ->action(function (Request $request, Database $dbForProject) {
        $timeout = \intval($request->getHeader('x-getapp-timeout'));
