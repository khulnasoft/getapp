...
trait DatabasesBase
{
    ...
    public function testUpdateDocument(array $data): array
    {
        ...
        $response = $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/collections/' . $data['moviesId'] . '/documents/' . $id, array_merge([
            'content-type' => 'application/json',
            'x-getapp-project' => $this->getProject()['$id'],
            'x-getapp-timestamp' => DateTime::formatTz(DateTime::now()),
        ], $this->getHeaders()), [
            'data' => [
                'title' => 'Thor: Ragnarok',
            ],
        ...
        $response = $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/collections/' . $data['moviesId'] . '/documents/' . $id, array_merge([
            'content-type' => 'application/json',
            'x-getapp-project' => $this->getProject()['$id'],
            'x-getapp-timestamp' => DateTime::formatTz(DateTime::addSeconds(new \DateTime(), -1000)),
        ], $this->getHeaders()), [
            'data' => [
                'title' => 'Thor: Ragnarok',
            ],
    ...
    public function testInvalidDocumentStructure()
    {
        ...
        $invalidRange = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/collections/' . $collectionId . '/attributes/integer', array_merge([
            'content-type' => 'application/json', 'x-getapp-project' => $this->getProject()['$id'],
            'x-getapp-key' => $this->getProject()['apiKey']
        ]), [
            'key' => 'invalidRange',
            'required' => false,
