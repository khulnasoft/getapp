...
class VCSConsoleClientTest extends Scope
{
    ...
    public function testGetInstallation(string $installationId): void
    {
        ...
        $this->assertEquals('getapp-test', $installation['body']['organization']);
    }
    ...
    public function testListRepositories(string $installationId): void
    {
        ...
        $this->assertEquals($repositories['body']['providerRepositories'][0]['organization'], 'getapp-test');
    ...
    public function testGetRepository(string $installationId): void
    {
        ...
        $this->assertEquals($repository['body']['organization'], 'getapp-test');
    ...
    public function testCreateRepository(string $installationId): void
    {
        ...
        $this->assertEquals('getapp-test', $repository['body']['organization']);
        ...
        $result = $github->deleteRepository('getapp-test', 'test-repo-1');
