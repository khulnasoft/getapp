...
def main(context):
    ...
    return context.res.json({
        ...
        'APPWRITE_FUNCTION_TRIGGER' : context.req.headers.get('x-getapp-trigger', ''),
        ...
        'APPWRITE_FUNCTION_EVENT' : context.req.headers.get('x-getapp-event', ''),
        'APPWRITE_FUNCTION_EVENT_DATA' : context.req.body_raw,
        'APPWRITE_FUNCTION_DATA' : context.req.body_raw,
        'APPWRITE_FUNCTION_USER_ID' : context.req.headers.get('x-getapp-user-id', ''),
        'APPWRITE_FUNCTION_JWT' : context.req.headers.get('x-getapp-user-jwt', ''),
