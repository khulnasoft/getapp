...
Future<dynamic> main(final context) async {
    ...
    response.json({
        ...
        'APPWRITE_FUNCTION_TRIGGER' : context.req.headers['x-getapp-trigger'] ?? '',
        ...
        'APPWRITE_FUNCTION_EVENT' : context.req.headers['x-getapp-event'] ?? '',
        'APPWRITE_FUNCTION_EVENT_DATA' : context.req.bodyRaw ?? '',
        'APPWRITE_FUNCTION_DATA' : context.req.bodyRaw ?? '',
        'APPWRITE_FUNCTION_USER_ID' : context.req.headers['x-getapp-user-id'] ?? '',
        'APPWRITE_FUNCTION_JWT' : context.req.headers['x-getapp-user-jwt'] ?? '',
